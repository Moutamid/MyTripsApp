...
public class BeachesinNorthActivity extends AppCompatActivity {
    private String[] itemTexts = {"Cap Malheureux", "Grand Gaube", "Mont Choisy", "Grand Baie", "Trou aux Biches"};
    ...
    private String[] itemName = {"Cap Malheureux Public Beach", "Grand GaubePublic Beach", "Mont Choisy Public Beach", "PereyberePublic Beach", "Trou aux Biches Public Beach"};
    private String[] itemName1 = {"District of Riviere du Rempart", "District of Riviere du Rempart", "District of Pamplemousses", "District of Riviere du Rempart", "District of Pamplemousses"};
    private int[] itemImages = {R.drawable.cap_malheureux_6, R.drawable.grand_gaube_1, R.drawable.mont_choisy_2, R.drawable.pereybere_beach_1, R.drawable.trou_aux_biches_1};
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if ((item.getItemId() == R.id.menu_item_1)) {
                    startActivity(new Intent(BeachesinNorthActivity.this, DashboardActivity.class));
                    finishAffinity();
                }
                return true;
            }
