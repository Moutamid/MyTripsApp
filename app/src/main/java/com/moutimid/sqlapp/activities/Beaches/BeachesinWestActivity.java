...
public class BeachesinWestActivity extends AppCompatActivity {
    private String[] itemTexts = {"Flic enFlac", "La Preneuse", "Le Morne Brabant", "Tamarin"};
    ...
    private String[] itemName = {"FlicenFlacPublic Beach", "La PreneusePublic Beach", "Le Morne Public Beach", "TamarinBay Beach"};
    private String[] itemName1 = {"District of Black River", "District of Black River", "District of Black River", "District of Black River"};
    private int[] itemImages = {R.drawable.flic_en_flac_3, R.drawable.la_preneuse_4, R.drawable.le_morne_beach_2, R.drawable.tamarin_3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_beaches_in_west);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if ((item.getItemId() == R.id.menu_item_1)) {
                    startActivity(new Intent(BeachesinWestActivity.this, DashboardActivity.class));
                    finishAffinity();
                }
                return true;
            }
