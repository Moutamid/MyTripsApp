        ...
        public void onClick(View view) {
            ...
            if (name.equals("Central")) {
                ...
                if (getAdapterPosition() == 0) {
                    ...
                    model.text2 = "Here are some interesting facts about the Old Grand Port Heritage Site:\n" +
                            "•\tIt has the first Dutch East India Company 'VOC' fort in the eastern hemisphere.\n" +
                            "•\tIt's the initial Dutch Fort built to defend against the sea.\n" +
                            "•\tIt experienced the first slave rebellion, where slaves set fire to the wooden fort.\n" +
                            "•\tSlaves influenced the architecture, leading to forts being built with stones for safety.\n" +
                            "In 1658, Dutch commander Cornelius Gooyer and his crew of 25 men built a small wooden fort shaped like a four-pointed star. Life was tough in Mauritius, with frequent attacks and fires by slaves, cyclones damaging the fort, and crops eaten by rodents. In 1694, one fire destroyed the fort, so the Dutch built a stone fort a few years later.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.frederik_hendrik_museum_4;
                    model.text4 = "The Dutch left Mauritius in 1710, destroying the site before leaving, with only the stone lodge left standing. You can still see the stone jetty below the fort in the lagoon.\n" +
                            "Later, the French settled in Mauritius and used the stone lodge as their administration center. They turned the site into a military outpost to protect Vieux Grand Port Bay. In 1806, the outpost moved to the newly built town of Mahebourg.\n" +
                            "Remnants of the powder/storehouse, prison, bakery, and workshop from the French period are on top of the Dutch ruins.\n" +
                            "In 1998, the Old Grand Port Heritage site was renovated to celebrate the 400th anniversary of the first Dutch landing in Mauritius. The site was inaugurated by the descendant of Maurits van Nassau, after whom Mauritius was named.\n" +
                            "The Frederik Hendrik Museum was built alongside the fort and opened in 1999. It houses memorabilia found during archaeological excavations, with a permanent exhibition in the main hall displaying old maps, military objects, potteries, cooking utensils, beads, coins, and more.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
                    ...
                    model.text9 = "On your way to the cultural site, check out the monument commemorating the first Dutch landing on 20th September 1598. The sailors were led by Admiral Wybrand Warwick, and you can see the Lion Mountain on the left.\n" +
                            "Address: The Old Grand Port Heritage site is on the South East coast, a 15-minute drive from the airport, and 4 km North of Mahebourg/Pointe d’Esny.\n" +
                            "The Frederik Hendrik Museum: Royal Road Old Grand Port Mauritius\n" +
                            "Visiting hours: \n" +
                            "Monday, Tuesday, Thursday, Friday, Saturday: 09h00 to 16h00 \n" +
                            "Wednesday: 11h00 to 16h00 \n" +
                            "Sunday: 09h00 to 12h00 \n" +
                            "The cultural heritage site is closed on public holidays.\n" +
                            "The entrance is free.\n" +
                            "Nearby attractions include Ile aux Aigrettes Nature Reserve, where you can explore Mauritius before the arrival of humans, and the historical Mahebourg Museum building. These are three must-do activities when you are in the Grand Port area.\n";
                    model.title8 = "";
                    model.text10 = "";
                    model.image4 = R.drawable.map_location;
                    model.text11 = "";
                    ...
                    model.text2 = "Renowned among holidaymakers as the epitome of beauty, the Belle Mare Beach is cherished not only by visitors but also by the island's residents who frequent the beach, particularly on weekends and holidays. This enclave retains an authentic charm, preserving the island's essence amidst the rapid development witnessed by other coastal cities, notably Grand Bay, Flic en Flac, and Black River.\n" +
                            "The Belle Mare Beach is an idyllic destination for swimming and diving, particularly on weekdays when the serene ambiance prevails. It offers an ideal retreat for nature enthusiasts, allowing them to relish miles of sandy expanse for sunbathing.\n" +
                    ...
                    model.text9 = "While the sea may be too challenging for a Sunday swim, the shore or shallow waters provide opportunities for sunbathing while children can revel in building sandcastles.\n" +
                            "The eastern coast boasts prominent hotels and restaurants, including establishments like Jalsa Beach Hotel & Spa, Radisson Blu Poste Lafayette Resort & Spa, and the esteemed Hôtel Constance Le Prince Maurice. \n" +
                ...
                if (getAdapterPosition() == 0) {
                    ...
                    model.text1 = "Standing proudly on the cliff's edge, overseeing the expanse of the sea, the Cave Point lighthouse stands as a beacon guiding incoming ships into the harbor of Port Louis. Adorned with distinctive red and white stripes running from top to bottom, this iconic lighthouse was inaugurated in 1910 and remains impeccably preserved. To reach the lighthouse's summit, one must ascend a 98-step staircase crafted from wood and cast iron.\n" +
                            ...
                            "\n" +
                            "It's advisable to avoid visiting the Albion Lighthouse on windy days.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text1 = "Located on the west coast of Mauritius, Flic en Flachas emerged as the second most popular tourist area in the country, following Grand Baie.\n" +
                            "Unlike the faster-paced development in the north, the west coast, including beautiful villages like Flic en Flac, has transformed from small fishing communities into charming towns, earning a reputation as a premier holiday destination.\n" +
                    ...
                    model.text2 = "Flic en Flac offers an ideal holiday experience with its excellent beaches, a variety of watersports, and a tranquil ambiance for complete relaxation. The location boasts a delightful setting with pristine white sand beaches and picturesque blue lagoons. Along the extensive 8 km beach, numerous restaurants, hotels, shops, and facilities cater to visitors.\n" +
                            ...
                            "Flic en Flac's beach, adorned with Casuarina Trees, features a fine lagoon protected by a reef, ensuring safe swimming and opportunities for various watersports.\n" +
                    ...
                    model.text5 = "Customize your Casela experience by choosing from a variety of activities, including quad biking, mountain climbing, interactions with cheetahs and lions, camel riding, zip-lining, and the exhilarating Canyon Swing. The Park offers four thematic worlds:\n" +
                            "1.\t<b>Mountain Kingdom:</b> Features various activities like Zig Zag Racer, Canyon Swing, and Zip and Splash Tour.\n" +
                            "2.\t<b>Big Cats Kingdom:</b> Offers unique experiences like walking and interacting with lions, cheetahs, and caracals.\n" +
                            "3.\t<b>Safari Kingdom:</b> Includes Quad biking, Giraffe Feeding, Segway, Rhino Interaction, and E-bike Safari.\n" +
                            "4.\t<b>Middle Kingdom:</b> Allows visitors to feed and interact with tortoises.\n";
                    ...
                    model.text9 = "•\t<b>Ziplining:</b> Enjoy the thrill of flying on zip lines, providing a bird's eye view of the park.\n" +
                            "•\t<b>Canyon Swing:</b> Experience a different form of bungee jumping from a 45m high platform.\n" +
                            "•\t<b>Mountain Climbing:</b> Embark on a Via Ferrata Canyon Tour through sugarcane fields and plateaus.\n";
                    model.title8 = "Safari and Animal Activities at Casela World of Adventures";
                    model.text10 = "";
                    model.image4 = R.drawable.casela_4;
                    model.text11 = "•\t<b>Walk with Lions:</b> Take a stroll alongside lions with expert guides ensuring safety.\n" +
                            "•\t<b>Interaction with Big Cats:</b> Get up close with lions, cheetahs, and caracals under supervision.\n" +
                            "•\t<b>Drive Thru:</b> A 45-minute drive to observe lions in their natural habitat.\n" +
                            "•\t<b>E-Bike Safari:</b> Explore the safari park on eco-friendly electric bikes.\n" +
                            "•\t<b>Segway Trip:</b> Discover the Yemen Nature Reserve Park on a Segway.\n" +
                            "•\t<b>Safari Quad Biking:</b> Navigate the park's hills, valleys, and rivers on quad bikes.\n" +
                            "•\t<b>Camel Riding:</b> Enjoy a camel ride through Casela park.\n";
                    model.image5 = R.drawable.casela_3;
                    model.text12 = "<b>History</b>\n" +
                            "Casela World of Adventures originated in December 1979 as a bird sanctuary and has evolved into a must-see attraction in Mauritius. Throughout the years, the park has continually expanded its array of adventures, from quad biking and bus safari trips to unforgettable encounters with big cats, traversing a Nepalese bridge, and ziplining above trees and canyons.\n" +
                            "Today, visitors can engage in activities such as feeding giraffes, interacting with brightly colored lorikeets and pygmy hippos, exploring the hilly landscape on camelback, fishing for tilapias, and embarking on a fun e-bike safari trip around the park.\n" +
                            "<b>Conservation</b>\n" +
                            "Remaining true to its founding vision, Casela World of Adventures is actively committed to the conservation and protection of endangered species. In February 2015, the park gained notoriety with Her Royal Highness Princess Stephanie of Monaco becoming its patron. Princess Stephanie, renowned for her dedication to elephant protection in Asia, wholeheartedly supported the conservation efforts of Mauritius' leading visitor attraction.\n";
                    Stash.put("model", model);
                    intent = new Intent(context, BeachDetails.class);
                    context.startActivity(intent);
                } else if (getAdapterPosition() == 3) {
                    ...
                    model.text1 = "Tamarin Bay Beach in Mauritius is a renowned coastal gem located on the west coast of the island, just past the village of Black River. Widely celebrated for its natural beauty and surf-friendly conditions, Tamarin Bay attracts locals and visitors alike. \n" +
                            "The region was once known as Santosha Bay, evident in the faintly painted word 'Santosha' on some buildings. It was a hidden gem, providing avid surfers with some of the planet's best waves. Interestingly, locals initially refrained from naming the beach to keep its surfable seas a secret from outsiders.\n" +
                            "The broader recognition of Tamarin Bay came with the release of the iconic surf documentary \"Forgotten Island of Santosha\" by Larry and Roger Yates in 1974, immortalizing the area. Tamarin Bay boasts two globally acclaimed surfing spots: ‘Dal’ on its left (south) and ‘Black Stone’ on the right (north) of the bay.\n" +
                            "Tamarin Bay is a frequent habitat for dolphins, particularly Spinners and Bottlenose dolphins. These playful creatures are often spotted in the bay during the early morning before returning to the open sea. Numerous boat companies provide morning trips for tourists to observe and swim with dolphins.Tamarin is renowned for its apartments and the excellent service it extends to tourists.\n";
                    model.title1 = "Surfing Hub";
                    model.image1 = R.drawable.tamarin_2;
                    model.text2 = "Tamarin Bay is famed for being one of the best surfing spots in Mauritius. Since the 1970s, it has been a central hub for surfers, initially introduced by Australians living on the island's west coast. The surf breaks draw enthusiasts, and access to this iconic spot is considered a privileged right.\n" +
                            "<b>Authentic Charm</b>\n" +
                            "Despite its reputation as a premier surfing destination, Tamarin Bay retains an authentic and genuine atmosphere. Local families frequent the beach for a relaxing break or a leisurely stroll during the week, creating a vibrant yet laid-back ambiance.\n" +
                            "<b>Swimming Cautions</b>\n" +
                            "While Tamarin Bay is a haven for surfers, swimming is not recommended for children and inexperienced swimmers. The presence of unpredictable currents and substantial waves breaking along the shore makes it less suitable for casual swimming.\n" +
                            "<b>Beach Atmosphere</b>\n" +
                            "Tamarin Bay is a popular destination for both locals and tourists. The beach may be more crowded on weekends and holidays, offering a lively atmosphere and a chance to witness the vibrant beach culture.\n" +
                            "<b>Time Recommendations</b>\n" +
                            "For those planning a visit, the best times to enjoy Tamarin Bay are early in the morning from 8:00 to 11:00 or in the afternoon from 13:00 to 16:00. During these periods, the beach offers favorable conditions for various activities.\n" +
                            "<b>Activities</b>\n" +
                            "\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.tamarin_1;
                    model.text4 = "Apart from surfing, Tamarin Bay provides opportunities for diverse water activities, including stand-up paddleboarding, bodyboarding, catamaran tours, swimming with dolphins, speed boat trips, and kayaking.\n" +
                            "In summary, Tamarin Bay Beach stands out as a dynamic and authentic coastal destination, offering a perfect blend of surfing excitement, natural beauty, and a lively beach atmosphere.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
                    ...
                    model.text1 = "To enhance your holiday experience in Mauritius, be sure to explore the Martello Tower Museum. Prepare to be fascinated by the artifacts, and the living conditions that characterize this historical period.As a relic of Mauritius' history, the Martello Tower Museum, located on the La Preneuse beach in Black River, is essential for those seeking a deeper understanding of the island's past.\n" +
                            "<b>Origin of the Martello Towers </b>\n" +
                            "The British first encountered one of these fortresses during a fierce battle at Mortella Bay in Corsica in 1794. Manned by the French, the tower impressed the British, who decided to build similar structures to safeguard their empire. Remnants of these towers can still be found in some former colonies and along the shores of England, characterized by a conical shape, thick walls, and slight variations.\n" +
                            "<b>The Martello Tower in Mauritius </b>\n" +
                            "The Martello Tower at La Preneuse has been meticulously restored and converted into a Heritage Museum. Nestled among casuarina trees, it stands as a testament to history.\n" +
                            "<b>Is it Martello or Mortella? </b>\n" +
                            "Contrary to a common misconception, 'Mortella' and 'Martello' are not related. Mortella Bay is named after a shrub abundant in Corsica, where the battle took place. 'Martello' means hammer in Italian, and in the past, a fire on the tower's flat roof served as a warning of approaching enemies. In Italy, the alarm was signaled by striking a bell with a hammer or 'martello.'\n";
                    model.title1 = "The Story behind the Martello Towers in Mauritius";
                    model.image1 = R.drawable.matello_tower_1;
                    model.text2 = "In the early 19th century, after the British captured Mauritius, concerns arose about a potential French insurrection with the abolition of slavery and the end of free labor. To protect the island, the British decided to construct five Martello Towers along the west coast at strategic locations near river mouths.\n" +
                            "The Martello towers wereprimarily built using basalt rock. The construction involved royal engineers, skilled stonecutters from India, carpenters, and, regrettably, slave labor for heavy tasks. Sand dunes called batteries were erected in front of the towers by the slaves. Each tower featured two cannons on the flat rooftop, capable of 360-degree rotation. The construction of the five towers spanned three years, but they never saw any action.\n";
                    ...
                    model.text10 = "Tuesday to Saturday: 09h30 to 17h00 \n" +
                            "Sunday: 09h30 to 13h00 \n" +
                            "Public Holidays: open except on 1 May, 25 December, 1 and 2 January, 1 February, 12 March. \n" +
                            "Closed on Mondays.\n" +
                            "Guided tours occur every half hour, and no advance booking is required. Simply walk in, pay the entrance fee, and a guide will welcome you for a tour.\n";
                    model.image4 = R.drawable.map_location;
                    model.text11 = "";
                    model.image5 = R.drawable.map_location;
                    model.text12 = "";
                    ...
                    model.text1 = "Added to the World Heritage List in 2008, the Le Morne Cultural Landscape is a mountain on the southwestern edge of Mauritius, extending into the Indian Ocean. This site served as a refuge for runaway slaves, commonly referred to as maroons, spanning the 18th century until the early 1900s.\n" +
                            "The mountain bears an almost fortress-like character, featuring vertical cliffs encircling it, steep slopes crisscrossed by ravines and valleys, and, at its summit, a relatively level plateau—all of which offered refuge to the maroon slaves.\n" +
                            "A wide gorge, referred to as the V-Gap or the mountain's crucial entry point, posed challenges for accessing the plateau. Both oral traditions and early written records suggest the presence of a narrow and hazardous passage that the maroons had to navigate to evade pursuers and find sanctuary at the summit.\n" +
                            "Archaeological excavations conducted in cave shelters on the mountain unveiled ashy deposits, providing evidence of fire utilization. Additionally, the discovery of the 300-year-old remains of a young sheep supports the notion that maroons occupied the mountain's summit, successfully securing their survival.\n" +
                            "The distinctive and fragile ecosystem of Le Morne Brabant Mountain harbors numerous endemic plant species, some of which are among the rarest in the world.\n";
                    model.title1 = "";
                    ...
                    model.text9 = "A notable sculpture, crafted by Haitian artist Fritz Laratte, embodies the theme of liberation from slavery. It narrates the tale of a slave who, through prayer, witnessed the sudden release of his hands from the chains of servitude.\n" +
                            "The unique Ah-yee shop, an integral part of Trou-Chenille village since its inception, served as a crucial source of basic necessities for the villagers. Testimonies reveal that the villagers relocated along with the shop.\n" +
                            "Stella Maris, the initial Catholic chapel in Le Morne dating back to 1891, originally situated in Trou-Chenille, found its relocation to L’Embrasure during WWI. Following destruction by a cyclone in 1975, it was reconstructed in concrete in Le Morne Village in 1987.\n";
                    model.title8 = "";
                    model.text10 = "";
                    model.image4 = R.drawable.brabant_7;
                    model.text11 = "Trou-Chenille, an integral component of the cultural heritage within the Le Morne Cultural Landscape, retains an open-air museum featuring five traditional huts portraying various aspects of daily life.\n" +
                            "Archaeological investigations uncovered evidence of a 19th-20th century settlement, Macaque, at the foot of Le Morne Brabant, likely associated with the Labonté and Béguinot families from Madagascar.\n";
                    ...
                    model.text1 = "The Maconde viewpoint is locatedon the southern coast of Baie du Cap, a charming and modest village celebrated for its striking natural allure and untamed, rugged coastlines. The viewpoint is nestled on a curved stretch of the coastal road atop a small rocky cliff. The landscape unfolds with picturesque vistas, featuring the vibrant red earth, lush green forests, rows of palm trees, and the glistening expanse of the Indian Ocean, creating a truly mesmerizing experience.\n" +
                            "Legend has it that the name \"Maconde\" traces its roots to the era of slavery, where runaway slaves from the Makonde tribe in Mozambique sought refuge in this area, while others believe it was named after Governor Jean Baptiste Henri Conde, who constructed an outlook on the cliff.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.maconde_2;
                    model.text2 = "Access to this region was historically challenging, and it wasn't until the 1920s that the first road was constructed, overcoming the difficulties posed by the low-lying coast and uneven terrain. Recent renovations have significantly enhanced safety. The winding road along basalt cliffs, with the rhythmic sounds of the ocean against the rocks, provides a captivating spectacle, making it a favored spot for those captivated by ocean swells.\n" +
                            "To reach the viewpoint, ascend a set of narrow stairs, where you'll be greeted by panoramic views of the ocean, the nearby coastal village, and occasional fishermen along the shore.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.map_location;
                    model.text4 = "";
                    ...
                    model.text1 = "The Seven Coloured Earths form a geological wonder and a popular tourist destination situated in the Chamarel plain of the Rivière Noire District in southwestern Mauritius. This unique site encompasses small sand dunes exhibiting seven distinctive colors—red, brown, violet, green, blue, purple, and yellow. The remarkable characteristic of this location lies in the settling of differently colored sands in distinct layers, creating surrealistic and striped patterns on the dunes. Over time, rains have sculpted captivating designs into the hillside, resulting in an effect reminiscent of earthen meringue.\n" +
                            ...
                            "The term \"Seven Coloured Earths\" serves as a descriptive, rather than an official, name. Various versions, including \"Chamarel Seven Coloured Earths,\" \"Chamarel Coloured Earth(s),\" \"Coloured Earth,\" and Terres des Sept Couleurs in French, have been reported.\n" +
                            "This phenomenon can be replicated on a smaller scale by taking sands of different colors, mixing them together, and observing their eventual separation into a layered spectrum.\n" +
                            "Since the 1960s, this site has evolved into one of Mauritius' major tourist attractions. Presently, the dunes are safeguarded by a wooden fence, and visitors are prohibited from climbing on them. However, observation outposts along the fence allow visitors to enjoy the scenery. Curio shops in the vicinity offer small test tubes containing the colored sands.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text1 = "Unquestionably the tallest single-drop waterfall in Mauritius, standing at an impressive height of approximately 100m, the Chamarel Waterfall is a captivating natural wonder nestled amidst lush vegetation. Fueled by the convergence of three distinct streams flowing into the Saint Denis River, the waterfall exhibits a formidable rush, boasting a peak flow rate exceeding 40,000 m³ per minute.\n" +
                            ...
                            "Perched on the edge of a basalt cliff, the Chamarel Waterfall cascades into an oval pool before meandering through a 6km canyon fringed by tropical forests, eventually reaching Baie du Cap. The sight not only immerses the senses in freshness but also serves as a stunning testament to millions of years of volcanic activity. The dramatic landscape is shaped by lavas from two distinct ages. The brecciated basalt layer near the base dates back to 10 to 8 million years ago, overlaying a second layer from the intermediate period between 3.5 and 1.7 million years ago.\n" +
                            "Embark on a three-hour trek through the secret valley of the Chamarel Waterfall, leading you to the waterfall's base, where you can enjoy a refreshing swim in the pool as the majestic waterfall showers you from above.\n" +
                            "This location, characterized by its exceptional beauty, will mesmerize you with sights and sounds reminiscent of a true tropical rainforest. \n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text1 = "Nestled in the fertile valley of the South West region of Mauritius, the Rhumerie de Chamarel offers a captivating experience surrounded by expansive sugarcane plantations seamlessly integrated with pineapples and other tropical fruits.\n" +
                            "Radiating warmth and authenticity, the Rhumerie de Chamarel Distillery invites visitors to partake in a comprehensive tourism journey, encompassing a guided tour of the distillery, rum tasting, and a delightful meal at L’Alchimiste, its distinctive \"A la Carte\" restaurant.\n" +
                            "The design of Rhumerie de Chamarel is a testament to its commitment to providing a holistic tourism experience, seamlessly blending with the stunning natural surroundings through the use of wood, natural stone, and water, fostering a sense of communion with nature.\n" +
                            "Guided Tour of Rhumerie de Chamarel embark on a guided tour of the Rhumerie de Chamarel with experienced guides taking you behind the scenes, offering detailed explanations of the rum-making process during your distillery visit.\n" +
                    ...
                    model.text4 = "The focus of Rhumerie de Chamarel's rum-making process is to ensure a high-quality, eco-friendly agricultural rum. From cultivation to fermentation and sophisticated distillation, the distillery takes pride in producing rum by distilling fresh, fermented cane juice, deviating from the traditional molasses-based approach.\n" +
                            ...
                            "Tourist Information\n" +
                            "•\tOpened from Monday to Saturday from 9.30 am to 5.30 pm.\n" +
                            "•\tThe guided visit and rum tasting last approximately 30-40 minutes.\n" +
                            "•\tChildren (up to 12 years old) must be accompanied by their parents, and rum tasting is not included.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
                    ...
                    model.text1 = "The Curious Corner is the sole science museum in Chamarel, located in the southwestern part of Mauritius. It caters to inquisitive minds, both young and old, who revel in the challenges presented by puzzles. For children, it serves as a stimulating environment, fostering curiosity, enhancing the thought process, and promoting growth. The space also appeals to couples and parents, creating an ambiance conducive to social interaction and daily encounters with numerous people.\n" +
                            "This venue has become a delightful choice for celebrating birthdays, exchanging gifts with loved ones, or expressing care for one another in a unique setting, creating lasting memories. Families and relatives also frequent the Curious Corner, drawn by its captivating allure.\n" +
                            "While most tourists visit Mauritius for its beaches and blue lagoon, the Curious Corner offers a distinct adventure and a touch of strangeness. \n";
                    model.title1 = "";
                    model.image1 = R.drawable.curious_corner_4;
                    model.text2 = "Located opposite the entrance of Chamarel's Seven Coloured Earth, the Curious Corner was constructed with the primary aim of surprising visitors.\n" +
                            "Spanning an area of 5,000 sq. meters, the adventure at the Curious Corner is filled with optical illusions that spark curiosity, boasting 40 exhibits to explore. A full visit typically takes around one and a half hours to experience all the thrills the place has to offer.\n" +
                            "Activities at the Curious Corner:\n" +
                            "1.\t<b>Upside-Down Room:</b> Experience the illusion of standing upside down, where the earth appears above your head, and the sky seems below your feet. The room challenges gravity, providing an excellent opportunity for unique photographs.\n" +
                            "2.\t<b>Staircase Music Room:</b> Ascend a staircase that produces musical notes with each step, adding an interactive and enjoyable element to the experience.\n" +
                            "3.\t<b>Light-Tapping Room:</b> Engage in a room where tapping on lights earns points, creating moments of fun and delight.\n" +
                            "4.\t<b>Ames Room:</b> Named after Adelbert Ames, this room features a trapezoidal shape that distorts perspective, making individuals appear larger or smaller depending on their position in the room.\n";
                    model.title2 = "";
                    model.text3 = "";
                    ...
                    model.text9 = "6.\t<b>Laser Music Room:</b> Play your favorite tunes using laser beams, putting your musical skills to the test.\n" +
                            "7.\t<b>Corner Café:</b> Relax in a pleasant garden setting, enjoying a variety of food items, including ice cream, pizzas, burgers, snacks, and smoothies.\n" +
                            "8.\t<b>Gift Shop ('Puzzles and Things'):</b> Purchase souvenirs, including local rum produced at the distillery, Mauritian crafts, jewelry, and an exclusive line of clothing.\n" +
                            "<b>Special Guide:</b> The Curious Corner's staff is always ready to assist and provide information, ensuring a pleasant and engaging visit.\n" +
                            "<b>Group Visits:</b> Special prices are offered to groups, making group visits a cost-effective and enjoyable way to experience the attraction with friends, family, and loved ones.\n" +
                            "<b>Operating Information:</b>\n" +
                            "•\tOpening Hours: 9 AM to 5 PM, seven days a week.\n";
                    model.title8 = "";
                    model.text10 = "";
                    model.image4 = R.drawable.map_location;
                    model.text11 = "";
                ...
                if (getAdapterPosition() == 0) {
                    ...
                    model.text1 = "Situated along the northern coast of Mauritius, overlooking the lagoon in Cap-Malheureux, stands a small church distinguished by its striking red roof, known as Notre Dame Auxiliatrice. Regarded as an emblematic symbol of the island, this location affords breathtaking vistas of Coin de Mire, a nearby islet situated less than ten kilometers off the north coast of Mauritius.\n" +
                            ...
                            "<b>Embark on a Journey Through a Unique Setting/b>\n";
                    model.title1 = "";
                    ...
                    model.text4 = "A detour to Cap Malheureux provides an opportunity to extend the exploration to the marine cemetery or the nearby Tamil temple. As serene as a sanctuary, Cap Malheureux serves as an ideal haven for recharging one's spirits.\n"
                    ;
                    model.title3 = "A Must-Visit Destination in Mauritius";
                    model.text5 = "This enchanting chapel is a highlight not to be overlooked during your stay in Mauritius. Conceived by Max Boullé and constructed by Raoul Lolliot in 1938, it received consecration from the Vicar General and Bishop Richard Lee on August 7, 1938.\n";
                    ...
                    model.text9 = "Throughout its history, the garden weathered periods of neglect and upheaval, with directors like James Duncan contributing to its restoration and enhancement. In 1866, during a malaria epidemic, the garden played a crucial role in producing Eucalyptus trees to combat the disease.\n" +
                            ...
                            "\n" +
                            "The Sir Seewoosagur Ramgoolam Botanic Garden stands as a testament to Mauritius's botanical heritage, offering visitors a captivating journey through its lush landscapes and rich history.\n";
                    ...
                    model.text1 = "Explore the remnants of the Balaclava Ruins situated within the enchanting grounds of Maritim Resort and Spa, nestled along the shores of Turtle Bay. Immerse yourself in our Mauritian heritage as you visit the fort, perched gracefully over Riviere Citron on the scenic Northwest coast.\n" +
                            "<b>Balaclava Ruins</b>\n" +
                            "Turtle Bay has a historical significance as a favored stop for ships traveling from Europe to the East during the 17th century. Initially named 'Ebony Bay' by the Dutch, the abundance of ebony trees in the area, ideal for ship repairs, led to its designation. Over time, the bay earned the name 'Turtle Bay,' possibly due to the presence of numerous turtles in the bay.\n" +
                            "<b>Balaclava Ruins History</b>\n";
                    model.title1 = "";
                    model.image1 = R.drawable.baie_de_larsenal;
                    model.text2 = "Moving into the 18th century, when the French settled in Mauritius, Governor Mahe de Labourdonnais relocated the administration from Mahebourg to the North, resulting in the establishment of Port Louis. The iron from Balaclava was crucial in constructing the new capital, its harbor, and supporting military efforts in India, including an iron foundry, naval arsenal, and gunpowder factory.\n" +
                            "<b>Cannon at Balaclava</b>\n" +
                            "In 1774, a powder store explosion occurred, sparing some structures like the flour mill, sawmill, and the building housing ironworks. In 1864, the estate was sold to Mr. Wiehe, who built 'Mon Desir' and a school. Later, it became a popular holiday destination for wealthy Mauritians. Mr. Wiehe also established a modern rum distillery.\n" +
                            "<b>Balaclava Ruins Today</b>\n" +
                            "Currently owned by a German hotel chain and a Mauritian family, preserving this heritage site is a priority. The Chateau Mon Desir restaurant was constructed on the original Mon Desir site, offering a panoramic view of the ruins and Turtle Bay.\n" +
                            "<b>Location</b>\n" +
                            "Situated within the Maritim Hotel's 35-hectare estate on the Southwest coast, a mere 10-minute drive from Grand Bay, this open-air museum awaits your exploration. \n" +
                            "Visitors are advised to contact Maritim Resort for permission due to occasional film and fashion shoots at the site.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.map_location;
                    model.text4 = "";
                    ...
                    model.text1 = "Grand Bay, also known as Grand Baie, is a coastal village and prominent tourist destination situated in the Rivière du Rempart district at the northern tip of Mauritius. In the 17th century, the Dutch referred to it as De Bogt Zonder Eyndt (Bay Without End), a name that resonates when one explores the village. Today, Grand Bay stands out as the most favored holiday spot in Mauritius.\n" +
                            ...
                            "\n" +
                            "Grand Bay enjoys a well-connected bus route, facilitating easy travel to key locations in Mauritius, including Port Louis, Triolet, Goodlands, and Grand Gaube.\n" +
                            "<b>Climate</b>\n" +
                            "Boasting a favorable climate year-round, Grand Bay offers warm summers and mild winters. With sheltered beaches and lagoons, the region is an excellent choice for a holiday at any time.\n" +
                            "<b>Activities</b>\n";
                    model.title1 = "";
                    model.image1 = R.drawable.parasailing;
                    model.text2 = "Visitors to Grand Bay can engage in a plethora of activities beyond sunbathing, such as safe swimming, sailing, windsurfing, parasailing, and various water sports. The region is also ideal for exploring the underwater marine life through activities like the Underwater Sea Walk, submarine excursions, and the Underwater Scooter. Divers can discover numerous diving sites along the coral reefs just a few kilometers from the shore.\n" +
                            "<b>Hotels</b>\n" +
                            "The hospitality industry in Mauritius, particularly Grand Bay, has witnessed significant changes over the years. From being a hidden paradise known to a select few travelers, Mauritius has transformed into a popular holiday destination with a diverse range of hotel options, guesthouses, private apartments, and villas. Grand Bay caters to various preferences, from deluxe resorts to cozy rooms for rent.\n" +
                            "\n" +
                            "Prominent hotels in Grand Bay include Veranda Grand Bay, Le Mauricia Hotel, 20 Sud, Ocean Villas, Royal Palm, Ventura Hotel, and Merville Beach Resort.\n" +
                            "<b>Grand Bay Beaches</b>\n";
                    model.title2 = "";
                    model.text3 = "";
                    ...
                    model.text1 = "Le Caudan Waterfront is as a prominent commercial development in Port Louis, the capital city of Mauritius, offering a diverse array of amenities such as shops, banking facilities, casinos, cinemas, restaurants, a marina, and the renowned five-star hotel, Le Labourdonnais.\n" +
                            ...
                            "<b>Historically Significant Spots</b>\n" +
                            "Several areas within Le Caudan Waterfront hold historical significance. The first meteorological observatory in the Indian Ocean, now home to the Food Court and the Namasté restaurant, is one such spot. The Blue Penny Museum occupies the former Docks office building.\n" +
                            "The naming of different wings within the complex reflects episodes from the country's colonial history:\n" +
                            "Barkly Wharf: Named after Sir Henry Barkly, a Member of Parliament of the British government and appointed governor of Mauritius from 1863-1870.\n" +
                            "Le Pavillon wing: Derived from Pavillon Street on an ancient map of Port Louis, speculated to have origins during the period when Port Louis was called ‘Port Napoléon.’\n" +
                            "Dias Pier: A tribute to Diogo Dias, brother of the famous navigator Barthoulomeu Dias, believed to be the first to record the Mascarene Islands on a navigation map.\n" +
                            "<b>Modern Day Attraction</b>\n";
                    model.title1 = "";
                    ...
                    model.text1 = "The Government House in Port Louis is one of the oldest structures, maintaining its graceful presence since the days of the French colony. Although its current appearance differs from its original form, the construction of the Government House began under the leadership of the first French governors, Nicolas de Maupin (1729 – 1735) and Mahé de Labourdonnais (1735 – 1746), who also used it as his residence. The building served as the official venue for the Governor's administrative activities, as well as a host for various receptions and functions.\n" +
                            "Under the governance of Mahé de La Bourdonnais, Port Louis emerged as a significant naval base and shipbuilding center. During his tenure, several structures were erected, some of which still endure today, including parts of the Government House, the Chateau de Mon Plaisir in Pamplemousses, and the Line Barracks. The French East India Company maintained control of the island until 1767.\n" +
                            "Originally, the building featured a wooden structure with palm leaf coverings, which was later replaced by a one-story construction during Nicolas de Maupin's era. Mahé de Labourdonnais subsequently expanded the ground floor in 1738, and the building was then designated as Hôtel du Gouvernement. Over time, through the French and British colonial periods, the structure underwent additional modifications and enhancements, culminating in the final form we recognize today.\n" +
                            "Adjacent to the structure, a statue of Queen Victoria, bearing her trademark solemn expression, stands prominently. Regrettably, the building is not open to visitors.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text1 = "In the heart of the bustling capital of the island, Port Louis, between the former government hotel and the waterfront overlooking the port, lies the Place d'Armes. Known to all Mauritians, the Place d'Armes is a square in the capital adorned with statues of the founding fathers of Mauritius.\n" +
                            "The Place d'Armes is a must-visit location as it is where north-south traffic converges, and the main access points to the city meet.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.place_darmes_2;
                    model.text2 = "Built during the time of Mahé de La Bourdonnais, his statue stands at the entrance of the Place d'Armes. Also known for its towering palm trees, the Place d'Armes features a three-lane avenue that has hosted many dignitaries from around the world.\n" +
                            "\n" +
                            "It is also the oldest part of the city of Port Louis, where one can find the headquarters of numerous banks, commercial houses, and consulates. However, the old period buildings have given way to a much more modern architecture.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.port_louis_8;
                    model.text4 = "The Place d'Armes remains the ideal starting point for your visit to the capital. Nearby, you will find several city landmarks, including the government hotel, the oldest theater in the Indian Ocean, some still cobbled roads like Vieux Conseil Street and Georges Guibert Street. Also in the vicinity are St Louis Cathedral, a Catholic church, and St James Cathedral, a Protestant church. You can also explore the central market and many other museums.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
                    ...
                    model.text1 = "The Blue Penny Museum in Mauritius was inaugurated in November 2001 and is dedicated to showcasing the history and art of the island. Its name is derived from the famous 1847 Blue Penny and Red Penny stamps, which hold great historical significance.\n" +
                            "Here's a brief history of the Blue Penny Museum:\n" +
                            ...
                            "2.\t<b>Museum Inauguration (2001):</b> The Blue Penny Museum officially opened its doors to the public in November 2001. It was established as a cultural institution aimed at preserving and showcasing Mauritius's rich history and artistic heritage.\n" +
                            "3.\t<b>Conservation Efforts:</b> Given the extreme rarity and value of the Blue Penny stamps, conservation efforts were implemented. The originals are illuminated only temporarily to prevent damage from prolonged exposure. Visitors to the museum typically view replicas of the stamps, ensuring the long-term preservation of the priceless artifacts.\n" +
                            "4.\t<b>Founder - The Mauritius Commercial Bank:</b> The museum was founded by The Mauritius Commercial Bank, one of the leading financial institutions in Mauritius. This initiative reflects the bank's commitment to preserving and promoting the cultural heritage of the island.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.blue_penny_museum_1;
                    model.text2 = "5.\t<b>Additional Artifacts: In addition to the Blue Penny stamps, the museum houses other notable artifacts, including the original statue of Paul and Virginia. Crafted by Prosper d'Épinay in 1881, this statue adds to the cultural and artistic richness of the museum's collection.\n" +
                            "The Blue Penny Museum has become a significant cultural institution in Mauritius, attracting both locals and tourists interested in exploring the island's history through its valuable artifacts and exhibits.\n" +
                            "The Blue Penny Museum is structured across two floors, each offering distinct features and exhibits:\n" +
                            "<b>Ground Floor:</b>\n" +
                            "1.\t<b>Souvenir Shop: Visitors are welcomed by a souvenir shop on the ground floor, providing an opportunity to purchase mementos related to the museum and Mauritius.\n" +
                            "2.\t<b>Temporary Exhibition Room: The ground floor houses a temporary exhibition room, showcasing rotating exhibits that may vary over time, allowing for diverse and dynamic displays.\n" +
                            "First Floor:\n" +
                            "1.\t<b>The Age of Discovery:</b> This exhibition room narrates the stories of pioneers who undertook the first oceanic voyages to reach the Mascarene Islands. It prominently features ancient maps that document this historic journey.\n" +
                            "2.\t<b>The Island Builders:</b> Covering three significant periods in Mauritius's history—the Dutch Period, the French Period, and the English Taking Over—this room provides a comprehensive overview of the island's historical evolution.\n" +
                            "3.\t<b>Port Louis:</b> This exhibition room focuses on the origins and history of Port Louis, offering insights into the development and growth of the city.\n" +
                            "4.\t<b>The Postal Adventure:</b> Dedicated to the postal history of Mauritius, this room proudly displays two stamps from the renowned Blue Penny collection, contributing to the island's philatelic heritage.\n" +
                            "5.\t<b>Engraved Memory:</b> Honoring Joseph Osmond Barnard, the first individual to engrave stamps in Mauritius, this room serves as a tribute to his significant contributions to the field.\n" +
                            "Overall, the Blue Penny Museum is thoughtfully organized to provide visitors with a captivating journey through Mauritius's history, art, and unique cultural heritage.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.map_location;
                    model.text4 = "";
                    ...
                    model.text1 = "The St. Louis Cathedral, locally known as 'Katedral Sin Lwi,' is situated in Port Louis, not far from Champ de Mars, making it one of the oldest churches in Mauritius. As the seat of the bishop of the diocese of Port Louis, this religious edifice has undergone multiple demolitions and rebuilds throughout its history.\n" +
                            "Initially erected between 1752 and 1756 as a temporary wooden chapel where the Bank of Mauritius stands today, the cathedral faced destruction due to cyclones and wartime usage. Mahe de Labourdonnais, the visionary behind the church's location, completed it in 1756. However, a cyclone in April 1773 brought it down completely. In 1782, a new church opened but was closed due to structural issues. Sir Robert Farquhar reconstructed it in 1814. Demolished again in 1928 and rebuilt in 1933 under Mgr James Leen, the present structure, with its larger size and historic features like the facade and stone towers, emerged.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.text1;
                    model.text2 = "The interior preserves relics from the past, such as statues, paintings, and furniture. The altar, in use since earlier years, holds historical significance. In 2007, marking its 160th anniversary as a cathedral, the building underwent extensive renovation, restoring its prominence in Port Louis.\n" +
                            "The cathedral serves as the burial place for its bishops, a tradition in the Catholic Church. Six bishops, including Mgrs Hankinson, Meurin, O’Neil, Bilsborrow, Leen, and the latest, Cardinal Margéot, interred in July 2009, rest beneath the choir tiling.\n";
                    model.title2 = "";
                    model.text3 = "";
                    model.image2 = R.drawable.map_location;
                    model.text4 = "";
                    ...
                    model.text1 = "The Natural History Museum in Port Louis is located on the ground floor of the Mauritius Institute Building, a structure recognized as a National Heritage, situated in the vibrant heart of the City of Port Louis. Erected between 1880 and 1884, the Mauritius Institute Building is a partial emulation of the Colombo Museum of African Modern Art building in Sri Lanka, designed by British architect M. Mann.\n" +
                            ...
                            "Dedicated to the systematic collection, study, and documentation of the fauna and flora of Mauritius and the Mascarene Islands, the museum has evolved into a center for information and exchange across various natural history fields in the Mascarene region.\n" +
                            ...
                            "Key features of the Natural History Museum in Port Louis:\n" +
                            "1.\t<b>Exhibits and Displays:</b> The museum typically features exhibits on various aspects of natural history, including geology, paleontology, botany, and zoology. Displays may include fossils, specimens of indigenous plants, and information about the unique ecosystems found in Mauritius.\n" +
                            "2.\t<b>Endemic Species:</b> Mauritius is known for its unique flora and fauna, and the museum often highlights endemic species that are found nowhere else in the world. This can include information about rare plants, birds, and other wildlife.\n" +
                            "3.\t<b>Educational Content:</b> Natural history museums often serve an educational purpose, providing valuable information about the island's geological history, evolution of its species, and the importance of conservation.\n" +
                            "4.\t<b>Research and Conservation:</b> Some natural history museums engage in research and conservation efforts. They may collaborate with scientists, researchers, and conservationists to contribute to the understanding and preservation of the island's natural environment.\n" +
                            "5.\t<b>Interactive and Engaging Displays:</b> Modern museums often incorporate interactive displays, multimedia presentations, and engaging activities to make the learning experience more enjoyable for visitors of all ages.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text1 = "The Aapravasi Ghat is a historical site located in Port Louis, the capital city of Mauritius. It holds great significance in the history of the island and is recognized as a UNESCO World Heritage Site. The history of the Aapravasi Ghat is closely tied to the indentured labor system that shaped the social and economic landscape of Mauritius.\n" +
                            ...
                            "4.\t<b>End of Indenture:</b> The indenture system continued until the early 20th century when it was officially abolished. The Aapravasi Ghat continued to be used for processing immigrants until 1920. After the cessation of the indenture system, the site underwent various transformations, serving different purposes over the years.\n" +
                            "5.\t<b>UNESCO World Heritage Site:</b> In 2006, the Aapravasi Ghat was designated as a UNESCO World Heritage Site in recognition of its historical importance in the global migration of indentured laborers and its impact on the multicultural identity of Mauritius.\n";
                    model.title1 = "";
                    ...
                    model.text1 = "The present-day museum building was erected as the General Post Office between 1865 and 1870. It is located by the harbor, adjacent to the customs building in the heart of the city.\n" +
                            "Construction commenced in January 1865 under the supervision of Surveyor General Morrison. By 1868, three-quarters of the building was completed, with an additional two years required to finish the entire project. The construction expenses amounted to £10,000 to £11,000, employing approximately 80 workers. It officially opened in December 1870.\n" +
                            "The architecture serves as a notable illustration of Victorian design in public colonial structures from the era of Queen Victoria, mirroring similar structures found in countries such as India, Sri Lanka, South Africa, Trinidad, and Guyana.\n" +
                            "It served as a replacement for the former General Post Office situated on Government Street near Government House, which had been the post office's headquarters since 1847.\n" +
                            "Since December 21, 1870, it has functioned as the primary post office of Mauritius, and in April 1877, the Central Telegraph Office also took residence in the building.\n" +
                            "The Postmaster General made his residence in the building, and it became the hub for mail from the 33 rural post offices built between the 1870s and 1890s on the island.\n" +
                            ...
                            "The postal museum, inaugurated in 2001, showcases exhibits detailing the postal and telecommunications history of the island. Notably, the world-renowned Red and Blue \"Post Office\" Mauritius stamps are not on display here but at the nearby Blue Penny Museum.\n";
                    model.title1 = "";
                    model.image1 = R.drawable.map_location;
                    model.text2 = "";
                    model.title2 = "";
                    ...
                    model.text4 = "Option 2 offers a guided tour of the entire park, providing an opportunity to delve deeper into the mysteries of the ocean and its inhabitants. \n" +
                            "Odysseo Experience Highlights:\n" +
                            "1.\t<b>The Lagoon:</b> Immerse yourself in the Mauritian territory, exploring the lagoon's calm waters, vibrant fish, seagrass beds, mangroves, and coral reefs.\n" +
                            "2.\t<b>Inland Forests:</b> Venture inland to discover species in their habitats, exploring lakes, rivers, and forests with diverse freshwater, insect, and reptile inhabitants.\n" +
                            "3.\t<b>Coral Reefs:</b> Dive into the blue waters of the Indian Ocean to unveil the secrets and biodiversity of the majestic coral reefs.\n" +
                            "4.\t<b>Open Sea:</b> Experience a fully immersive underwater journey as stingrays, sharks, eels, and various fish swim alongside you in the tunnel.\n" +
                            "5.\t<b>Invertebrates:</b> Explore the fascinating world of invertebrates, comprising 95% of animal species on Earth, and unravel their incredible evolutionary history.\n" +
                            "6.\t<b>Sub-Oceanic View:</b> Gain a better understanding of sharks and their vital role in the interconnected oceans, advocating for their protection.\n" +
                            "Upon completing your visit, make your way to the gift store, where a diverse range of offerings awaits. From stuffed animals and t-shirts to books, educational games exploring the marine environment, goodies, and jewelry, you can find an array of souvenirs to bring the oceanic experience home with you.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
                    ...
                    model.text4 = "The visit concludes delectably at the Tasting Bar, where you can sample products from the distillery or orchards, including jams, fruit jellies, fruit juices, and sorbets.\n" +
                            "Beyond the Château of Labourdonnais tour, you can explore the shop offering authentic local products, including decorative items related to colonial life and gardens, rum, fruit jellies, spices, and more.\n" +
                            "La Table du Château provides a unique and refined culinary experience inspired by the fruits and vegetables from the Labourdonnais orchards. Set in a contemporary ambiance, it offers a gastronomic journey unveiling the flavors of Mauritius.\n";
                    model.title3 = "";
                    model.text5 = "";
                    model.title4 = "";
                    model.text6 = "";
